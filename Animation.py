...
InputButtom1 = Button(InputWindow, text="CONFIRM", width=15,
                      height=2, command=GetName, bg="yellow", fg="red")
InputButtom1.pack()
...
def MoveSnake():
    ...
    for i in range(1, len(Snake)):
        if SnakeHeadPosition != canvas.coords(Snake[-1]) and OverLapping(SnakeHeadPosition, canvas.coords(Snake[i])) and IsPause == False and IsBoss == False and IsCheat == False:
            GameOver = True
